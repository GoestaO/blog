...
class _SQLAlchemyState(object):
    """Remembers configuration for the (db, classes) tuple."""
...
class SQLAlchemy(object):
    ...
    versioning examples.::
        ...
        classes = Flask(__name__)
        db = SQLAlchemy(classes, session_extensions=[VersionedListener()])
    ...
    def get_binds(self, app=None):
        ...
        This is suitable for use of sessionmaker(binds=db.get_binds(classes)).
        """
