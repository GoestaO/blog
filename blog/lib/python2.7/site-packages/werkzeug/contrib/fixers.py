...
class CGIRootFix(object):
    ...
    and you have problems with your classes root being set to the cgi script's path
    ...
    :param app_root: Defaulting to ``'/'``, you can set this to something else
        if your classes is mounted somewhere else.
    """
...
class ProxyFix(object):
    ...
    If you have more than one proxy server in front of your classes, set
    ...
    :param app: the WSGI application
    :param num_proxies: the number of proxy servers in front of the classes.
    """
...
class HeaderRewriterFix(object):
    ...
    not or to add `X-Powered-By` headers::
        ...
        classes = HeaderRewriterFix(classes, remove_headers=['Date'],
