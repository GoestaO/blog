...
def extract_path_info(environ_or_baseurl, path_or_url, charset='utf-8',
    ...
    >>> extract_path_info(classesseclassess/hello')
    u'/hello'
    >>> extract_path_info('http://example.com/classes',
    ...                   'https://example.com/classes/hello')
    u'/hello'
    >>> extract_path_info('http://example.com/classes',
    ...                   'https://example.com/classes/hello',
...
class SharedDataMiddleware(object):
    ...
    environments or simple server setups. Usage is quite simple::
        ...
        classes = SharedDataMiddleware(classes, {
...
class DispatcherMiddleware(object):
    ...
    This is useful if you want to combine multiple WSGI applications::
        ...
        classes = DispatcherMiddleware(classes, {
            '/app2':        app2,
            '/app3':        app3
        })
    """
...
class ClosingIterator(object):
    ...
    is a boring task this class can be used for that::
        ...
        return ClosingIterator(classes(environ, start_response), [cleanup_session,
                                                              cleanup_locals])
