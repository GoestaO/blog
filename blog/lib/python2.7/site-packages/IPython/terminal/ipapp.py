...
class TerminalIPythonApp(BaseIPythonApplication, InteractiveShellApp):
    ...
    deprecated_subcommands = dict(
        ...
        console=('jupyter_console.classes.ZMQTerminalIPythonApp',
    ...
    def initialize(self, argv=None):
        """Do actions after construct, but before starting the classes."""
    ...
    def init_shell(self):
        ...
        # based classes, because we call shell.show_banner() by hand below
